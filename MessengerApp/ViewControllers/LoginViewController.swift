...
//  MessengerApp
//
//  Created by 라완 💕 on 03/06/1444 AH.
//
...
final class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //scrollView.addSubview(goregisterButton)
        setlayOut()
       // facebookButton.delegate = self
...
//        googleLogInButton.addTarget(self, action: #selector(googleSignInButtonTapped), for: .touchUpInside)
    ...
    func setlayOut(){
        ...
        imageView.heightAnchor.constraint(equalToConstant: CGFloat(150)).isActive = true
        
        
        emailField.translatesAutoresizingMaskIntoConstraints = false
        emailField.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 10).isActive = true
        ...
        emailField.heightAnchor.constraint(equalToConstant: CGFloat(50)).isActive = true
        ...
        passwordField.heightAnchor.constraint(equalToConstant: CGFloat(50)).isActive = true
        ...
        loginButton.heightAnchor.constraint(equalToConstant: CGFloat(50)).isActive = true
        
        facebookButton.translatesAutoresizingMaskIntoConstraints = false
        facebookButton.topAnchor.constraint(equalTo: loginButton.bottomAnchor, constant: 10).isActive = true
        ...
        facebookButton.heightAnchor.constraint(equalToConstant: CGFloat(50)).isActive = true
        ...
        googleButton.heightAnchor.constraint(equalToConstant: CGFloat(50)).isActive = true
